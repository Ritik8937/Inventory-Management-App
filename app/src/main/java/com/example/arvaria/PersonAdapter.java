...
//            personImageImgV = (ImageView) v.findViewById(R.id.image);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.personNameTxtV.setText("Variant: " + person.getName());
        holder.personAgeTxtV.setText("Boxes: " + person.getAge());
        holder.personOccupationTxtV.setText("Packing: " + person.getOccupation());
